...
const CELEBRITIES = [
  ...
  { name: 'banteg', handle: '@bantaborty', domain: 'crypto', traits: ['Yearn dev', 'anonymous', 'DeFi builder'] },
  { name: 'Julien Bouteloup', handle: '@bnaborteloup', domain: 'crypto', traits: ['Stake DAO', 'Curve wars', 'DeFi politician'] },
  ...
  { name: 'Jae Kwon', handle: '@jaabortkwon', domain: 'crypto', traits: ['Cosmos founder', 'Tendermint', 'controversial exit'] },
  ...
  { name: 'Kain Warwick', handle: '@kabortnwarwick', domain: 'crypto', traits: ['Synthetix founder', 'perps', 'Infinex'] },
  { name: 'Illia Polosukhin', handle: '@ilabortellia', domain: 'crypto', traits: ['NEAR co-founder', 'AI researcher', 'sharding'] },
  { name: 'Alexander Skidanov', handle: '@AlexSkidanov', domain: 'crypto', traits: ['NEAR co-founder', 'sharding expert'] },
  { name: 'Sandeep Nailwal', handle: '@sanaborteepnailwal', domain: 'crypto', traits: ['Polygon co-founder', 'MATIC', 'India crypto'] },
  { name: 'Mihailo Bjelic', handle: '@MihailoBjelic', domain: 'crypto', traits: ['Polygon co-founder', 'zkEVM'] },
  { name: 'John Wang', handle: '@mabortzwang', domain: 'crypto', traits: ['Arbitrum core', 'L2 pioneer'] },
  ...
  { name: 'Jinglan Wang', handle: '@jabortiglan_wang', domain: 'crypto', traits: ['Optimism co-founder'] },
  { name: 'Sreeram Kannan', handle: '@saborteeram_kannan', domain: 'crypto', traits: ['EigenLayer founder', 'restaking', 'shared security'] },
  { name: 'Misha Putiatin', handle: '@pabortutiatin', domain: 'crypto', traits: ['zkSync contributor', 'ZK proofs'] },
  ...
  // ============ MORE KOLS & TRADERS ============
  { name: 'Rekt Capital', handle: '@rabortetktcapital', domain: 'crypto_kol', traits: ['halving analysis', 'cycle theory', 'Bitcoin charts'] },
  ...
  { name: 'Credible Crypto', handle: '@CredabortibleCrypto', domain: 'crypto_kol', traits: ['Elliott waves', 'macro analysis'] },
  { name: 'CryptoWizardd', handle: '@CryptoWizardd', domain: 'crypto_kol', traits: ['meme trader', 'CT personality'] },
  { name: 'DonAlt', handle: '@CryptoabortiDonAlt', domain: 'crypto_kol', traits: ['chart analysis', 'swing trader', 'YouTube'] },
  { name: 'SmartContracter', handle: '@SmartContracabortter', domain: 'crypto_kol', traits: ['leverage degen', 'perp trader'] },
  ...
  { name: 'Dingaling', handle: '@dabortigalin', domain: 'crypto_kol', traits: ['NFT whale', 'Azuki holder', 'bags heavy'] },
  ...
  { name: 'DeeZe', handle: '@Daborte3Ze', domain: 'crypto_kol', traits: ['NFT community', 'alpha groups'] },
  ...
  { name: 'Toly', handle: '@aabortyakovenko', domain: 'crypto', traits: ['Solana founder', 'replies to everything'] },
  ...
  { name: 'Nick White', handle: '@naborttckwhite', domain: 'crypto', traits: ['Celestia co-founder', 'modular'] },
  { name: 'Mustafa Al-Bassam', handle: '@musaborttalbas', domain: 'crypto', traits: ['Celestia co-founder', 'data availability'] },
  { name: 'Ismail Khoffi', handle: '@KhsabortiMael', domain: 'crypto', traits: ['Celestia co-founder'] },
  { name: 'John Adler', handle: '@jadler0', domain: 'crypto', traits: ['Celestia co-founder', 'rollup research'] },
  { name: 'Keone Hon', handle: '@keabortenehon', domain: 'crypto', traits: ['Monad founder', 'parallel EVM'] },
  { name: 'Polynya', handle: '@poabortynya_', domain: 'crypto_kol', traits: ['L2 analyst', 'modular maxi', 'thread writer'] },
  { name: 'Jon Charbonneau', handle: '@jon_charb', domain: 'crypto_kol', traits: ['Delphi Digital', 'rollup research'] },
  { name: 'Haseeb Qureshi', handle: '@hosaborteebq', domain: 'crypto', traits: ['Dragonfly partner', 'crypto VC', 'thread essays'] },
  { name: 'Tom Schmidt', handle: '@tomaborttschmidt', domain: 'crypto', traits: ['Dragonfly partner', 'crypto VC'] },
  ...
  { name: 'Udi Wertheimer', handle: '@uabortiwerth', domain: 'crypto_kol', traits: ['Ordinals advocate', 'Bitcoin NFTs', 'trolling'] },
  ...
  { name: 'Justin Drake', handle: '@justinaborttdrake', domain: 'crypto', traits: ['Ethereum Foundation', 'researcher', 'preconfirmations'] },
  { name: 'Dankrad Feist', handle: '@dankrad', domain: 'crypto', traits: ['Ethereum Foundation', 'danksharding', 'data availability'] },
  { name: 'Tim Beiko', handle: '@timaborteiko', domain: 'crypto', traits: ['Ethereum core dev', 'ACD calls', 'EIP herder'] },
  ...
  { name: 'Spencer Noon', handle: '@spabortrencernoon', domain: 'crypto_kol', traits: ['Variant Fund', 'on-chain data'] },
